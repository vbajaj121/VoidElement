...
export function HeroClient({ content }: { content: HeroContent }) {
  ...
  return (
    ...
    // and forces Lenis to correct the scroll position, visible as the page
    // re-settling a couple of times right after load. dvh tracks the live
    // viewport instead, so there's nothing to correct.
